...
@section('content')
    ...
    <form action="{{ route('progress.store') }}" method="POST" class="needs-validation form-create" novalidate>
        @csrf
        @method('POST')
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex align-items-center gap-2">
                                    <a class="btn btn-sm btn-outline-warning" href="{{ route('progress.edit', $data->id) }}">
                                        <i class='bx bxs-edit'></i>
                                    </a>
                                    <form action="{{ route('progress.destroy', $data->id) }}" method="POST" id="deleteProgress-{{ $data->id }}">
                                        @csrf
                                        @method('DELETE')
